...
import { DataShareService } from 'app/main/services/data-share.service';
...
//ENROL USER TAB
  ...
  //   var wstoken: string = this.current_moodle.token;
  //   var url: string = this.current_moodle.url;
  ...
  changeTitle(title:string){
    ...
    return this.moodleApiService.core_course_update_courses(this.current_moodle.url, params);
  }
  ...
  changeUserInfo(user:any, value:string){
    ...
    return this.moodleApiService.core_user_update_users(this.current_moodle.url, params);
  }
  changeTitleHandler(){
  ...
  getUsers(query, fieldIndex, queryIndex){
    ...
    this.moodleApiService.core_user_get_users(this.current_moodle.url, params)
      .subscribe(
        data => {
  ...
  //   }
  //   this.moodleApiService.enrol_manual_enrol_users(this.current_moodle.url, params).subscribe(
  //     data => {
  //       if(data == null){
  //
  //         swal(
  ...
  //         enrolments: enrolments
  //       }
  //       this.moodleApiService.enrol_manual_unenrol_users(this.current_moodle.url, params).subscribe(
  //         data => {
  //           if(data == null){
  //             var i;
  ...
  //   }
  //
  //   this.moodleApiService.gradereport_overview_get_course_grades(this.current_moodle.url, params).subscribe(
  //     data => {
  //       resultG = data.grades;
  //
